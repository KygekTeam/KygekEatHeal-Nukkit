...
public class HealCommand extends PluginCommand<EatHeal> {

    public HealCommand(String name, EatHeal owner) {
        super(name, owner);

        String desc = owner.getConfig().getString("heal-desc").isEmpty() ?
                "Heal yourself or a player" : owner.getConfig().getString("heal-desc");
        this.setDescription(desc);
        this.setAliases(owner.getConfig().getStringList("heal-aliases").toArray(new String[0]));
